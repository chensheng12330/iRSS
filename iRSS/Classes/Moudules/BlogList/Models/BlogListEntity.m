...
-(NSString*) description
{
    ...
    superStr = [superStr stringByAppendingFormat:@"nRSSID:[%ld] \nTitle:[%@] Link:[%@] Summary:[%@] \nContent:[%@] Date:[%@] Update:[%@]\nEnclosures:[%@] Identiffire:[%@] isRead:[%d]",(long)_nRSSID,_strTitle,_strLink,_strSummary,_strContent,_deDate,_deUpdated,_strEnclosures,_strIdentifier,_bIsRead];
